...
This plugin shows users URLs of Subversion repository, so if you use it in public network, please be careful about access rights management of Subversion repository.
